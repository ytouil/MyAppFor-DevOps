<%-- 
    Document   : Romanesque
    Created on : 28 mai 2021, 22:45:17
    Author     : HP
--%>
    ...
    <!--<span style="color:red;"> <% // = // r.getString(1) %></span>-->
        ...
        <main style="padding-top: 90px;">
            <section class="thumbSection">
                <h1 class="thumbTitle" style="color:white; padding-bottom: 20px">Romanesque</h1>
                    ...
                    <div class="swiper-wrapper" id="saad">
                        <c:forEach var="im5" items="${images5}"> 
                            ...
                            <div class="swiper-slide">
                                ...
                                <a class="thumbTile" type="button" href='Ctrl_selection?id=${im5.isbni}'>

                                    <img class="thumbTile__image" src="${im5.image}" width="339.39" height ="191.09"  border="1">
                                    <span style="color:white; display: none">${im5.isbni}</span>
                                    <% //System.out.println("isfasgfasg");%>
                                    <br>
                                    <a style="font-size: 20px"  onclick="return confirm('voulez vous vraiment le commander?')"  id="a" class="btn g dl" name="action"   href='insertcommande?id=${im5.isbni}'>Commander</a>
                                </a>
