<%-- 
    Document   : Epistolaire
    Created on : 28 mai 2021, 22:39:10
    Author     : HP
--%>
    ...
    <body style="background-color: #141414; ">
        ...
        <main style="padding-top: 90px;">
            <section class="thumbSection">
                <h1 class="thumbTitle" style="color:white; padding-bottom: 20px">Epistolaire</h1>
                    ...
                    <div class="swiper-wrapper" id="saad">
                        <c:forEach var="im3" items="${images3}">
                            ...
                            <div class="swiper-slide">
                                ...
                                <a class="thumbTile" type="button" href='Ctrl_selection?id=${im3.isbni}'>

                                    <img class="thumbTile__image" src="${im3.image}" width="339.39" height ="191.09"  border="1">
                                    <span style="color:white; display: none">${im3.isbni}</span>
                                    <% //System.out.println("isfasgfasg");%>
                                    <br>
                                    <a style="font-size: 20px"  onclick="return confirm('voulez vous vraiment le commander?')"  id="a" class="btn g dl" name="action"   href='insertcommande?id=${im3.isbni}'>Commander</a>
                                </a>
