<%-- 
    Document   : affichageinfo
    Created on : 25 mai 2021, 12:37:21
    Author     : HP
--%>
        ...
        <div class="container" style="padding-top: 90px;">
            <div class="row">
                ...
                <div class="col-md-4 md-6">
                    ...
                    <br>
                    <a  onclick="return confirm('voulez vous vraiment le commander?')" style="margin-left: 16%;width: 226px;margin-top: 5px;margin-bottom: 5px;" id="a" class="btn g dl" name="action"   href='insertcommande?id=${ISBN}'>Commander</a>
                </div>
            </div>
