<%-- 
    Document   : Poesie
    Created on : 25 mai 2021, 19:13:06
    Author     : HP
--%>
    ...
    <body style="background-color: #141414;">
        ...
        <main style="padding-top: 90px;">
            <section class="thumbSection">
                <h1 class="thumbTitle" style="color:white; padding-bottom: 20px">Poésie</h1>
                    ...
                    <div class="swiper-wrapper" id="saad">
                        <c:forEach var="im2" items="${images2}">
                            ...
                            <div class="swiper-slide">
                                ...
                                <a class="thumbTile" type="button" href='Ctrl_selection?id=${im2.isbni}'>

                                    <img class="thumbTile__image" src="${im2.image}" width="339.39" height ="191.09"  border="1">
                                    <span style="color:white; display: none">${im2.isbni}</span>
                                    <% //System.out.println("isfasgfasg");%>
                                    <br>
                                    <a style="font-size: 20px"  onclick="return confirm('voulez vous vraiment le commander?')"  id="a" class="btn g dl" name="action"   href='insertcommande?id=${im2.isbni}'>Commander</a>
                                </a>
