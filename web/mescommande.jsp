<%-- 
    Document   : mescommande.jsp
    Created on : 26 mai 2021, 00:45:12
    Author     : HP
--%>
    ...
    <body style="background-color: #141414;">
        ...
        <main style="padding-top: 90px;">
            <section class="thumbSection">
                                <h1 class="thumbTitle" style="color:white; padding-bottom: 20px">Mes commandes</h1>
                <div class="thumbTiles swiper-container">
                    <div class="swiper-wrapper" id="saad">
                        ...
                        <div class="swiper-slide">
                            ...
                            <a class="thumbTile" type="button" href='ctrl_selectioncommandes?id=${im1.isbni}'>

                                <img class="thumbTile__image" src="${im1.image}" width="339.39" height ="191.09"  border="1">
                                <span style="color:white; display: none">${im1.isbni}</span>
                                <% //System.out.println("isfasgfasg");%>
                                <br>
<!--                                <a style="font-size: 20px"  onclick="return confirm('voulez vous vraiment le commander?')"  id="a" class="btn g dl" name="action"   href='insertcommande?id=${im1.isbni}'>Recommander</a>-->
